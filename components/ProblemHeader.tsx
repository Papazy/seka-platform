          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              <div className="flex items-center space-x-3 mb-2">
                ...
                <h1 className="text-2xl font-semibold text-gray-900">{problemData.title}</h1>
                <span className={`px-2 py-1 text-xs font-medium rounded-full border ${getStatusColor(problemData.status)}`}>
