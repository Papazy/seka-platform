...
export default function TopUsers({
  ...
  const getRankIcon = (rank: number) => (
    <span className="text-gray-500 font-medium text-sm">#{rank}</span>
  );
      ...
      <div className="p-6">
            ...
            entry => (
              <div
                ...
                className={`flex items-center space-x-3 p-3 rounded-lg ${
                  entry.name === "You"
                    ? "bg-[#3ECF8E]/10 border border-[#3ECF8E]/20"
                    : "bg-gray-50"
                }`}
              >
        ...
        <div className="mt-4 pt-4 border-t border-gray-200">
          <div className="text-xs text-gray-500 text-center">
            ...
            {leaderboardData[activeTab as keyof typeof leaderboardData].length}{" "}
            users
          </div>
        </div>
      </div>
