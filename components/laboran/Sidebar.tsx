// components/laboran/Sidebar.tsx - Optimized Version
'use client'
...
const UserProfile = React.memo(({ 
  ...
  <div className={`p-4 border-t ${variant === 'mobile' ? 'absolute bottom-0 w-full bg-gray-50' : ''}`}>
    ...
    >
      <ArrowRightOnRectangleIcon className={`h-5 w-5 ${isCollapsed && variant === 'desktop' ? '' : 'mr-3'}`} />
