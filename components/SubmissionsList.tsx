    ...
    return (
      <div>
        ...
        <div className="text-center py-12">
          ...
          <p className="text-gray-600">Submit your solution to see results here.</p>
        </div>
      </div>
    );
  }
          ...
          <div key={submission.id} className="border border-gray-200 rounded-lg overflow-hidden">
            ...
            >
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center space-x-3">
                  <span className={`px-3 py-1 text-sm font-medium rounded-full border ${getSubmissionStatusColor(submission.status)}`}>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                <div>
                  ...
                  <div className="font-medium text-gray-900">{submission.executionTime || 'N/A'}</div>
                </div>
                <div>
                  <span className="text-gray-500">Memory:</span>
                  <div className="font-medium text-gray-900">{submission.memory || 'N/A'}</div>
                </div>
                <div>
            ...
            {expandedSubmission === submission.id && (
              <div className="border-t border-gray-200 bg-gray-50">
                <div className="p-4">
                  <div className="flex items-center justify-between mb-3">
                    <h4 className="text-sm font-medium text-gray-900">Submitted Code</h4>
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                        copyToClipboard(submission.code || '// Code not available');
                      }}
