/*
  ...
  - You are about to drop the `class_memberships` table. If the table is not empty, all the data it contains will be lost.
  ...
  - You are about to drop the `submission_test_case_results` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE `announcements` DROP FOREIGN KEY `announcements_class_id_fkey`;

-- DropForeignKey
ALTER TABLE `assignments` DROP FOREIGN KEY `assignments_author_id_fkey`;

-- DropForeignKey
ALTER TABLE `assignments` DROP FOREIGN KEY `assignments_class_id_fkey`;

-- DropForeignKey
ALTER TABLE `class_memberships` DROP FOREIGN KEY `class_memberships_class_id_fkey`;

-- DropForeignKey
ALTER TABLE `class_memberships` DROP FOREIGN KEY `class_memberships_user_id_fkey`;

-- DropForeignKey
ALTER TABLE `problems` DROP FOREIGN KEY `problems_assignment_id_fkey`;

-- DropForeignKey
ALTER TABLE `problems` DROP FOREIGN KEY `problems_author_id_fkey`;

-- DropForeignKey
ALTER TABLE `submission_test_case_results` DROP FOREIGN KEY `submission_test_case_results_submission_id_fkey`;

-- DropForeignKey
ALTER TABLE `submission_test_case_results` DROP FOREIGN KEY `submission_test_case_results_test_case_id_fkey`;

-- DropForeignKey
ALTER TABLE `submissions` DROP FOREIGN KEY `submissions_language_id_fkey`;

-- DropForeignKey
ALTER TABLE `submissions` DROP FOREIGN KEY `submissions_problem_id_fkey`;

-- DropForeignKey
ALTER TABLE `submissions` DROP FOREIGN KEY `submissions_user_id_fkey`;

-- DropForeignKey
ALTER TABLE `test_cases` DROP FOREIGN KEY `test_cases_problem_id_fkey`;
...
-- DropTable
DROP TABLE `submission_test_case_results`;
