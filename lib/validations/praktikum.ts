...
export function validatePraktikumForm(
  formData: PraktikumFormData,
  ...
  } else if (formData.kodePraktikum.length < 3 || formData.kodePraktikum.length > 20) {
    errors.kodePraktikum = 'Kode praktikum harus 3-20 karakter huruf besar dan angka'
  }
  ...
  if (!formData.kodeMk.trim()) {
    ...
    errors.kodeMk = 'Kode mata kuliah harus 3-20 karakter huruf besar dan angka'
  }
