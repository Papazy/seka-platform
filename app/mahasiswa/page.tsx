      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-xl font-semibold text-gray-900">Praktikum</h1>
              <p className="text-gray-600 mt-1 text-sm">
                Daftar kelas praktikum yang anda ikuti
              </p>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-6">
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600">
                  {activeTab === 'active' ? 'Kelas Aktif' : 'Kelas Selesai'}
                </div>
              </div>
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600">Asisten</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-semibold text-purple-600">
                  {activeTab === 'active' ? activeStats.learning : inactiveStats.learning}
                </div>
                <div className="text-sm text-gray-600">Praktikan</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#3ECF8E] focus:border-[#3ECF8E] text-sm text-gray-700"
                />
              </div>
            </div>
          </div>
        ...
        {filteredClasses.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Tidak ada kelas ditemukan</h3>
