    ...
    setSoalList(
      soalList.map(soal =>
        soal.id === soalId
          ? {
              ...soal,
              contohTestCase: soal.contohTestCase.filter(
                (_, idx) => idx !== index,
              ),
            }
          : soal,
  ...
  const validateForm = () => {
    ...
    for (let i = 0; i < soalList.length; i++) {
      ...
      if (
        ...
        !soal.testCase[0].outputDiharapkan.trim()
      ) {
              ...
              {bahasaLoading ? (
                ...
                <div className="bg-red-50 border border-red-200 rounded-lg p-4 text-center">
                  <p className="text-red-600">
                    Gagal memuat bahasa pemrograman
                  </p>
                  <button
                    type="button"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input
              ...
              onChange={e =>
                onUpdate(soal.id, "batasanMemoriKb", parseInt(e.target.value))
              }
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
              min="64000"
              max="1024000"
