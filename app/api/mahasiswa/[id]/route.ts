...
export async function DELETE(
  ...
  try {
    ...
    if (
      existingMahasiswa._count.pesertaPraktikum > 0 ||
      existingMahasiswa._count.asistenPraktikum > 0
    ) {
      return NextResponse.json(
        {
          error:
            "Tidak dapat menghapus mahasiswa yang masih terlibat dalam praktikum",
        },
        { status: 400 },
      );
    }
