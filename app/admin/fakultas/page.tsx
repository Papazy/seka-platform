...
export default function FakultasPage() {
  ...
  const handleSubmit = async (formData: { nama: string; kodeFakultas: string }) => {
    setIsSubmitting(true)
    try {
      const url = editingFakultas ? `/api/fakultas/${editingFakultas.id}` : '/api/fakultas'
  ...
  const columns = createFakultasColumns({ onEdit: handleEdit, onDelete: handleDelete })
    ...
    <div className="p-8">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
        <div className="flex items-center">
          ...
          <div className="ml-4">
            <div className="text-sm font-medium text-gray-500">Total Fakultas</div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-lg font-semibold text-gray-900">Data Fakultas</h2>
              <p className="text-sm text-gray-500">Kelola semua fakultas di sistem</p>
            </div>
            <button
              onClick={handleAdd}
        ...
        <div className="p-6">
          {data.length > 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <h3 className="mt-2 text-sm font-medium text-gray-900">Tidak ada fakultas</h3>
...
function FakultasForm({ 
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        <label htmlFor="kodeFakultas" className="block text-sm font-medium text-gray-700 mb-1">
          Kode Fakultas
        </label>
        <input
          type="text"
