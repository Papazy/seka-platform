...
export default function DosenDetailPage() {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'praktikum'>('overview')
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6">
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="flex-1 space-y-4">
              <div>
                <h2 className="text-xl font-bold text-gray-900">{dosen.nama}</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-center text-sm text-gray-600">
                  ...
                  {dosen.programStudi.kodeProdi} • {dosen.programStudi.fakultas.kodeFakultas}
                </div>
                <div className="flex items-center text-sm text-gray-600">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <p className="mt-1 text-sm text-gray-900">{dosen.programStudi.nama}</p>
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-gray-500">Kode Program Studi</label>
                        <p className="mt-1 text-sm text-gray-900">{dosen.programStudi.kodeProdi}</p>
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-gray-500">Fakultas</label>
                        <p className="mt-1 text-sm text-gray-900">{dosen.programStudi.fakultas.nama}</p>
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-gray-500">Kode Fakultas</label>
                        <p className="mt-1 text-sm text-gray-900">{dosen.programStudi.fakultas.kodeFakultas}</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {activeTab === 'praktikum' && (
              <div>
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Link href={`/laboran/dosen/${id}/assign-praktikum`}>
                    <Button size="sm" className="bg-[#3ECF8E] hover:bg-[#2EBF7B] text-white">
                      <UserGroupIcon className="h-4 w-4 mr-2" />
                      Assign Praktikum
                    </Button>
                  </Link>
                ...
                {dosen.dosenPraktikum && dosen.dosenPraktikum.length > 0 ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <h3 className="mt-2 text-sm font-medium text-gray-900">Belum mengajar praktikum</h3>
