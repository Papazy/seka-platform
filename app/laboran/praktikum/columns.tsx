    ...
    cell: ({ row }) => (
      <div className="text-sm">
        ...
        <p className="text-gray-500">
          {formatTime(row.original.jadwalJamMasuk)} - {formatTime(row.original.jadwalJamSelesai)}
        </p>
    ...
    cell: ({ row }) => (
      <div className="text-sm space-y-1">
        <div className="flex items-center">
          ...
          <span className="text-gray-900">{row.original._count.pesertaPraktikum}</span>
          <span className="text-gray-500 ml-1">Praktikan</span>
        </div>
        <div className="flex items-center">
          {/* <AcademicCapIcon className="h-4 w-4 text-gray-400 mr-1" /> */}
          <span className="text-gray-900">{row.original._count.asistenPraktikum}</span>
          <span className="text-gray-500 ml-1">Asisten</span>
        </div>
        <div className="text-gray-500 text-xs">
        <span className="text-gray-900">{row.original._count.dosenPraktikum}</span>
